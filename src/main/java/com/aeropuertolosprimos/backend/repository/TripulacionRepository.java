...
public interface TripulacionRepository
        extends JpaRepository<Tripulacion, Integer> {

    List<Tripulacion> findByAerolineaId(
            Integer aerolineaId
    );

    List<Tripulacion> findByEstadoTripulacionId(
